...
test("should change table status while loading", () => {
    const endState = cartReducer(startState, tableLoading(true));
...
test("should change table data status while loading", () => {
    const endState = cartReducer(startState, workerLoading(true, "777af5ec74250300043ae461"));
...
test("should set workers to empty state", () => {
    ...
    const endState = cartReducer(startState, setWorkers(settedWorkers));
...
test("should add worker correctly", () => {
    ...
    const endState = cartReducer(startState, addWorker(newWorker));
...
test("should delete worker correctly", () => {
    const endState = cartReducer(startState, deleteWorker("607af5ec74250300043ae461"));
...
test("should update worker correctly", () => {
    ...
    const endState = cartReducer(startState, updateWorker(newWorkerData));
